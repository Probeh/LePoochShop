        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Members_Pooches_PoochId",
                        column: x => x.PoochId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveLast = table.Column<DateTime>(nullable: true),
                    MemberId = table.Column<int>(nullable: true),
                    PoochModelId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ActivityLogs_Pooches_PoochModelId",
                        column: x => x.PoochModelId,
                        principalTable: "Pooches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_PoochModelId",
                table: "ActivityLogs",
                column: "PoochModelId");
