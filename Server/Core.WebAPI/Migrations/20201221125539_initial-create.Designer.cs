...
namespace Core.WebAPI.Migrations
{
    ...
    [Migration("20201221125539_initial-create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Shared.Models.Entities.BreedModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Shared.Models.Entities.PoochModel", b =>
                {
                    b.HasOne("Core.Shared.Models.Entities.BreedModel", "Breed")
                        .WithMany()
                        .HasForeignKey("BreedId");

                    b.HasOne("Core.Shared.Models.Entities.MemberModel", "Owner")
                        .WithOne("Pooch")
                        .HasForeignKey("Core.Shared.Models.Entities.PoochModel", "OwnerId");
                });
